        ...
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    ?>
                    <form class="user" action="<?= base_url('transaksi/update/') ?><?= $table ?>/<?= $namaDonasi2 ?>" method="POST">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="nama_donasi">Nama Donasi :</label>
                                    <input type="text" name="nama_donasi" id="nama_donasi" class="form-control fw-bold text-danger" value="<?= $namaDonasi; ?>" disabled>
