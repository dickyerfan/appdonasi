        ...
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                <div class="card-header card-outline card-primary shadow">
                    ...
                    $namaDonasi2 = $this->uri->segment(5);
                    $namaDonasi2 = preg_replace("/[^a-zA-Z\']/", " ", $namaDonasi2);
                    $idDonasi = $this->uri->segment(3);
                    ?>
                    <a href="<?= base_url('detailDonasi/detail/'); ?><?= $idDonasi?>/<?= $namaDonasi ?>" id="kembali"><button class="btn btn-primary btn-sm float-end"><i class="fas fa-reply"></i> Kembali</button></a>
                </div>
                <div class="card-body">

                    <form class="user" action="<?= base_url('detailDonasi/update/') ?><?= $idDonasi?>/<?= $namaDonasi ?>" method="POST">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="nama_donasi">Nama Donasi :</label>
                                    <input type="text" name="nama_donasi" id="nama_donasi" class="form-control fw-bold text-danger" value="<?= $namaDonasi2; ?>" disabled>
