                ...
                <div class="card-header shadow">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-6">
                            <form action="<?= base_url('donasiUmum') ?>" method="get">
                                <!-- <input type="text" name="cari" class="form-control" placeholder="Cari Donasi"> -->
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="carouselExampleControls" class="carousel" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <?php foreach ($detailDonasi as $row) : ?>
                                <div class="carousel-item <?php if ($row->id_donasi == 1) {
                                                                echo 'active';
                                                            }  ?> ">
                                    <div class="card bg-primary card1">
                                        <div class="img-wrapper">
                                            ...
                                            <a href="<?= base_url(); ?>donasiUmum/detail/<?= $row->id_donasi ?>/<?= $row->nama_donasi; ?>">
                                                <img class="card-img-top img-thumbnail" src="<?= base_url('assets/photo/' . $row->photo) ?>">
                                            </a>
                                        </div>
                                        <div class="card-body">
