        ...
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                <div class="card-header card-outline card-primary shadow">
                    ...
                    ?>
                    <a href="<?= base_url('donasiKhusus/detail/'); ?><?= $idDonasi?>/<?= $namaDonasi ?>" id="kembali"><button class="btn btn-primary btn-sm float-end"><i class="fas fa-reply"></i> Kembali</button></a>
                </div>
                <div class="card-body">

                    <form class="user" action="<?= base_url('donasiKhusus/update/') ?><?= $idDonasi?>/<?= $namaDonasi ?>" method="POST">
                        <div class="row">
                            <div class="col-md-6">
