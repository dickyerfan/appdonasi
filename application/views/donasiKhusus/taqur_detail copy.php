                ...
                <div class="card-header shadow">
                    <div class="row">
                        ...
                        <div class="col-3">
                            ...
                            ?>
                            <a href="<?= base_url('donasiKhusus/detailTambah/'); ?><?=$idDonasi?>/<?= $table ?>"><button class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Input Transaksi</button></a>
                            <a href="<?= base_url('donasiKhusus/tabunganQurban'); ?>"><button class="btn btn-primary btn-sm float-end"><i class="fas fa-reply"></i> Kembali</button></a>
                        </div>
                    </div>
                </div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="<?=base_url(); ?>donasiKhusus/detailHapus/<?= $row->id_transaksi; ?>/<?= $row->nama_penabung; ?>/<?=$table?>" class="sweet"><i class="fas fa-fw fa-trash text-danger" data-bs-toggle="tooltip" title="Hapus Tabungan"></i></a>

                                            <a href="<?= base_url(); ?>donasiKhusus/detailRinci/<?= $row->id_transaksi; ?>/<?= $row->nama_penabung; ?>/<?=$table?>"><i class="fas fa-fw fa-info-circle text-success" data-bs-toggle="tooltip" title="Detail Tabungan"></i></a>
                                        </td>
