                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?=base_url() ?>donasiKhusus/edit/<?= $row->id_penabung; ?>"><i class="fas fa-fw fa-edit" data-bs-toggle="tooltip" title="Edit Data"></i></a>

                                            <a href="<?=base_url(); ?>donasiKhusus/hapus/<?= $row->id_penabung; ?>" class="sweet"><i class="fas fa-fw fa-trash text-danger" data-bs-toggle="tooltip" title="Hapus data"></i></a>

                                            <a href="<?= base_url(); ?>donasiKhusus/rinci/<?= $row->id_penabung; ?>"><i class="fas fa-fw fa-info-circle text-success" data-bs-toggle="tooltip" title="Detail data"></i></a>
                                        </td>
                                        <td><?= $row->nama_penabung ?></td>
                                        <td class="text-end"><?= number_format($row->jml_tabungan, 0, ',', '.');  ?>,-</td>
                                        <?php $tanggal = date('d M Y', strtotime($row->tgl_nabung)); ?>
