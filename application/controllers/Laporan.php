...
class Laporan extends CI_Controller
{
    ...
    public function jumat()
    {
        ...
        $this->load->view('templates/navbar');
        $this->load->view('templates/sidebar');
        $this->load->view('laporan/laporanJumat', $data);
        $this->load->view('templates/footer');
    }

    public function tambahDonasi()
    {
        $data['title'] = 'Form Tambah Donasi Lain-lain';
        $this->form_validation->set_rules('tanggal', 'Tanggal', 'required|trim');
        $this->form_validation->set_rules('lokasi', 'Lokasi', 'required|trim');
        $this->form_validation->set_rules('target', 'Target', 'required|trim');
        $this->form_validation->set_rules('distribusi1', 'Distribusi 1', 'required|trim');
        $this->form_validation->set_rules('donasi1', 'Donasi 1', 'required|trim');
